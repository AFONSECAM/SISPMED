...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">            
            <form action="/tesoreria/gastos/guardar" method="POST">                
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            <label for="codigoGas">Código</label>
                        <input id="codigoGas" type="text" readonly class="form-control <?php $__errorArgs = ['codigoGas'];
...
unset($__errorArgs, $__bag); ?>" name="codigoGas" value="<?php echo e($ultimoGasto->id+1); ?>" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\proyecto\resources\views/tesoreria/gastos/create.blade.php ENDPATH**/ ?>