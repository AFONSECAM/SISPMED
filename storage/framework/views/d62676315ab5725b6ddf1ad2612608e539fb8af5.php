            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control <?php $__errorArgs = ['codigoConv'];
...
unset($__errorArgs, $__bag); ?>" name="codigoConv" value="<?php echo e($convenio->codConv); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <label for="">IPS</label>
                        <input type="text"  class="form-control <?php $__errorArgs = ['nombreIPS'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="nombreIPS" value="<?php echo e($convenio->nomIPS); ?>">
                        <?php $__errorArgs = ['nombreIPS'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\proyecto\resources\views/empresa/convenios/edit.blade.php ENDPATH**/ ?>