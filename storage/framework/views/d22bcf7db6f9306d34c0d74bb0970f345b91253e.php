...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">            
            <form action="/tesoreria/recaudos/guardar" method="POST">                
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>" name="codigoReca" >
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="valorReca" type="text" class="form-control <?php $__errorArgs = ['valorReca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\proyecto\resources\views/tesoreria/recaudos/create.blade.php ENDPATH**/ ?>